        ...
        <div className="min-h-screen bg-[#001529] font-sans flex flex-col">
            ...
            <div className="flex-grow max-w-7xl mx-auto w-full px-6 py-12 pt-32">
                ...
                <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
                    <Title level={2} className="text-white mb-6 uppercase tracking-wider" style={{ color: 'white' }}>ResultsPage</Title>
                    <Paragraph className="text-gray-300 text-lg leading-relaxed mb-4" style={{ color: '#d1d5db' }}>
                        Đây là trang mẫu cho ResultsPage. Nội dung chi tiết sẽ được ban quản trị cập nhật trong thời gian sớm nhất.
                    </Paragraph>
