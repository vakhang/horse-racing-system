...
import {
    ...
    NotificationOutlined // <--- Bạn thêm chữ này vào là xong!
...
const AdminLayout = ({ children }) => {
    ...
    return (
        <Layout className="min-h-screen font-sans">
            ...
            <Sider collapsible collapsed={collapsed} onCollapse={(val) => setCollapsed(val)} theme="dark" width={260} className="shadow-2xl z-20">
